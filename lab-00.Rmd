...
```{r setup-tibble}
team_data <- tibble(
  name = c("Shreya", "Selena", "Kumi", 
           "Carla", "Ash"),
  github_username = c("ggshreya", "selena-314", "kuni-stevens", 
                      "cmartin658", "ashbrw7"), 
  colour = c("blue", "pink", "goldenrod1", 
             "purple", "green"),
  hobby = c("cello", "violin", "climbing", 
            "football", "art"),
  favourite_number = c(2, 7, 7, 9, 3)
  )
